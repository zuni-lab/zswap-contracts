...
pub fn tick_spacing_to_max_liquidity_per_tick(tick_spacing: I24) -> u128 {
  let min_tick = ((TickConstants::MIN_TICK.as_i256() / tick_spacing.as_i256()) * tick_spacing.as_i256()).as_i24();
  let max_tick = ((TickConstants::MAX_TICK.as_i256() / tick_spacing.as_i256()) * tick_spacing.as_i256()).as_i24();
